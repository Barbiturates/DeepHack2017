...
class Agent(object):
    """Abstract class for an agent which plays a game on Atari 2600."""

    def __init__(self, possible_actions=POSSIBLE_ACTIONS):
    ...
    def start_state(self):
        """
        The state this agent is in before the episode starts
